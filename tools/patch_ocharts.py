...
# +31 standard full-GPX route handoff.
...
new = r'''            // +31: standard GPX handoff parser. Reads rtept/trkpt/wpt
            ...
            wxLogMessage(_T("GEMGPX +31 READ points=%d path=%s"),
...
new = '''                if( routeValid ) {
                    wxLogMessage(_T("GEMROUTE +31 FULL ROUTE length=%.1f m points=%d"),
...
for a,b in [('GEMPROX +30','GEMPROX +31'),('GEMPOINT +30','GEMPOINT +31'),
            ('GEMROUTE +30','GEMROUTE +31'),('GEMVIEW +30','GEMVIEW +31'),
            ('GEMDIAG +30','GEMDIAG +31'),('GEMCANDIDATES +30','GEMCANDIDATES +31'),
            ('GEM +30','GEM +31')]:
    chart = chart.replace(a,b)
chart = chart.replace('GEMBUILD +31 production candidate output active',
                      'GEMBUILD +31 full GPX route scalability test active')
...
print("GEM +31: standard gem-route.gpx input, up to 512 GPX points, no route-length limit")
